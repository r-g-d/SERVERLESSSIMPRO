...
import resource.req
import resource.app
from schedulingInterface.ContainerPlacement import FirstFit, MinVectorDist, BestFit, WorstFit
...
from resource.req import req_num
...
def createContainer(req, createTime):
    ...
    elif ContainerPlacementStrategy == ConPlaceAlgo.BEST_FIT:
        noAvailablePM = BestFit(pmList , container)
    elif ContainerPlacementStrategy == ConPlaceAlgo.WORST_FIT:
        noAvailablePM = WorstFit(pmList , container)
    else:
